...
var Exports struct {
	...
	//
	//	process-logs: func(input: list<borrow<logview>>) -> result<list<outval>, string>
	ProcessLogs func(input cm.List[cm.Rep]) (result cm.Result[cm.List[Outval], cm.List[Outval], string])
}
